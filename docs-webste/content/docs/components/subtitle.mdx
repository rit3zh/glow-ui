...
<TypeTable
  type={{
    children: {
      description: "🧾 The subtitle content to render.",
      type: "React.ReactNode",
      required: true,
    },
    size: {
      description: "🔢 Font size for the subtitle text.",
      type: "number",
    },
    style: {
      description: "🎨 Custom style for the subtitle text.",
      type: "StyleProp<TextStyle>",
    },
    className: {
      description: "🧩 Optional class name for utility styling.",
      type: "string",
    },
  }}
/>
...
<Accordion title='Subtitle.types.ts'>
