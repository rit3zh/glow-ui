...
- [Colors.type.ts](https://github.com/your-repo/src/constants/colors/Colors.type.ts) for type definitions
- [Colors.ts](https://github.com/your-repo/src/constants/colors/Colors.ts) for implementation details
