...
const CLOSED = { height: 0, opacity: 0, '--mask-stop': '0%', y: 20 } as const;
const OPEN = {
  height: 'auto',
  opacity: 1,
  '--mask-stop': '100%',
...
/** The mask wipes the content in from the top as the height opens. */
const MASK_STYLE = {
  maskImage:
...
function AccordionContent({
  ...
  // Radix takes a child through `asChild`, not the Base UI `render` prop —
  // passing `render` here left the content unmounted entirely.
  return (
    <AnimatePresence>
      {keepRendered ? (
