...
>
  ...
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>Accordion.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>AccordionItem.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  ...
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>AccordionContent.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>AccordionTrigger.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  ...
  <SiTypescript  />
  <h3 style={{ fontWeight: "bold"}}>Accordion.types.ts</h3>
</div>
