...
Here’s the full **MDX-style props documentation** for your Card component parts: `CardHeader`, `CardTitle`, `CardDescription`, `CardContent`, and `CardFooter`.
...
>
  ...
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>Card.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>CardWrapper.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  ...
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>Footer.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>Subtitle.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  ...
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>Title.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  ...
  <SiTypescript  />
  <h3 style={{ fontWeight: "bold"}}>Card.types.ts</h3>
</div>
