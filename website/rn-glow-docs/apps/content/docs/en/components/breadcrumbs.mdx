...
>
  ...
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>BreadcrumbsList.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>BreadcrumbsSeparator.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  ...
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>BreadcrumbsItem.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>BreadcrumbsIcon.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  <FaCode size={28} />
  <h3 style={{ fontWeight: "bold" }}>BreadcrumbsView.tsx</h3>
</div>
    </AccordionTrigger>
...
>
  ...
  <SiTypescript  />
  <h3 style={{ fontWeight: "bold"}}>Breadcrumbs.types.ts</h3>
</div>
